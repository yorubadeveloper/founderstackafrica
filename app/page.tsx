...
export default async function Home() {
  ...
  return (
    <>
      ...
      {/* 2. Founder Flows */}
      {flows.length > 0 && (
        <section id="flows" className="bg-background py-16 md:py-24">
      ...
      <section id="categories" className="bg-background py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-10">
            Browse the stack
          </h2>
      ...
      {/* 6. Newsletter CTA */}
      <section id="newsletter" className="bg-muted/50 py-16 md:py-24">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            potentialAction: {
              "@type": "SearchAction",
              target: "https://founderstackafrica.com/?q={search_term_string}",
